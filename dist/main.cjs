// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.2.0-140.0.dev.
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main$body(args) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$currentError, sdk, flavor, raw, os, architecture, version, channel, url, toolName, sdkPath, archivePath, extractedFolder, pubCache, error, t1, t2, exception, t3, t4, versionFilePath, $async$exception, $async$exception1;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 8:
              ...
              $async$goto = J.get$length$asx(sdkPath) !== 0 ? 22 : 24;
              break;
            case 22:
              // then
