// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.12.0-261.0.dev.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _impl(args) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, flavor, raw, os, architecture, channel, version, url, toolName, sdkPath, t2, archivePath, extractedFolder, pubCache, versionFilePath, t1, sdk, $async$temp1;
