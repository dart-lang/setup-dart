// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.13.0-934680657.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 16:
              ...
              t2.toString;
              archivePath = A.join(t2, A.ParsedPath_ParsedPath$parse(url, $.$get$url().style).get$basename(), null, null);
              t2 = type$.String;
              $async$goto = 17;
            ...
            case 18:
              // returning from await.
              extractedFolder = $async$temp1.join($async$result, "dart-sdk", null, null);
              $async$goto = 19;
            ...
            case 15:
              ...
              t2.toString;
              pubCache = A.join(t2, ".pub-cache", null, null);
              A._asJSObject(t1.core).exportVariable("DART_HOME", sdkPath);
              A._asJSObject(t1.core).addPath(A.join(sdkPath, "bin", null, null));
              A._asJSObject(t1.core).exportVariable("PUB_CACHE", pubCache);
              A._asJSObject(t1.core).addPath(A.join(pubCache, "bin", null, null));
              t2 = type$.String;
              env = A.LinkedHashMap_LinkedHashMap$_empty(t2, t2);
              for (t2 = ["DART_DATA_HOME", "LOCALAPPDATA", "HOME", "XDG_STATE_HOME"], _i = 0; _i < 4; ++_i) {
                key = t2[_i];
                value = A._asStringQ(A._asJSObject(A._asJSObject(t1.process).env)[key]);
                if (value == null)
                  value = null;
                if (value != null)
            ...
            case 20:
              ...
              versionFilePath = A.join(sdkPath, "version", null, null);
              ...
              if (A._asString(A._asJSObject(t1.core).getInput("problem-matcher")) !== "false") {
                ...
                A.printString("::add-matcher::" + A.join(actionPath, "dart-analyzer.json", null, null));
              }
              $async$goto = 21;
    ...
    join(part1, part2, part3, part4) {
      var t1 = $.$get$context(),
        parts = A._setArrayType([part1, part2, part3, part4, null, null, null, null, null, null, null, null, null, null, null, null], type$.JSArray_nullable_String);
