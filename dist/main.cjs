// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 3.0.0-417.0.dev.
...
(function dartProgram() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Iterable, [A.EfficientLengthIterable, A.WhereIterable, A.WhereTypeIterable, A._AllMatchesIterable, A._StringAllMatchesIterable]);
