// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.3.0-120.0.dev.
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 20:
              ...
              $async$goto = 21;
              return A._asyncAwait(A.promiseToFuture(t2._as(t2._as(t1.exec).exec("dart", A._setArrayType(["--version"], type$.JSArray_String))), type$.void), $async$_impl);
            case 21:
              // returning from await.
            case 1:
              // return
