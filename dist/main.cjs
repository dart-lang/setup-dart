// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.4.0-9.0.dev.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main$body(args) {
      var $async$goto = 0,
        ...
        $async$handler = 1, $async$currentError, e, exception, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 9:
              ...
              if (sdk === "main") {
                ...
                if (B.JSString_methods.contains$1(sdk, "dev"))
                  ...
                  if (B.JSString_methods.contains$1(sdk, "main")) {
            ...
            case 20:
              ...
              $async$goto = 21;
              return A._asyncAwait(A.promiseToFuture(A.callMethod(t2._as(t1.exec), "exec", ["dart", A._setArrayType(["--version"], type$.JSArray_String)], t2), type$.void), $async$_impl);
            case 21:
              // returning from await.
            case 1:
              // return
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$goto = 4;
              return A._asyncAwait(A.promiseToFuture(A.callMethod(t2._as(t1.exec), "exec", ["dart", A._setArrayType(["pub", "token", "add", "https://pub.dev", "--env-var", "PUB_TOKEN"], type$.JSArray_String)], t2), type$.void), $async$createPubOIDCToken);
            case 4:
              // returning from await.
            case 1:
              // return
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = t1;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(t1._as(A.callConstructor(self.HttpClient, ["setup-dart", A._setArrayType([], type$.JSArray_Object), type$.nullable_JSObject._as(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["allowRedirects", true, "maxRedirects", 3, "allowRetries", true, "maxRetries", 3], type$.String, type$.Object)))], t1).getJson(string$.https_ + channel + "/" + flavor + "/latest/VERSION")), t1), $async$latestPublishedVersion);
            case 3:
              // returning from await.
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp3 = t2;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(t2._as(A.callConstructor(self.HttpClient, ["setup-dart", A._setArrayType([], type$.JSArray_Object), type$.nullable_JSObject._as(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["allowRedirects", true, "maxRedirects", 3, "allowRetries", true, "maxRetries", 3], t1, type$.Object)))], t2).getJson("https://storage.googleapis.com/storage/v1/b/dart-archive/o?prefix=" + ("channels/stable/release/" + sdkRelease + ".") + "&delimiter=/")), t2), $async$findLatestSdkForRelease);
            case 3:
              // returning from await.
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "version_Version___parse_tearOff$closure", "Version___parse_tearOff", 26);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A._createTables_setChars, A._createTables_setRange, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.Context_joinAll_closure, A._validateArgList_closure, A.Version__splitParts_closure, A.findLatestSdkForRelease_closure]);
