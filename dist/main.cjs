// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.2.0-170.0.dev.
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              version = null;
              channel = null;
              $async$goto = J.endsWith$1$s(sdk, ".x") ? 7 : 9;
              break;
            case 7:
              // then
              channel = "stable";
              versionPrefix = J.substring$2$s(sdk, 0, J.get$length$asx(sdk) - 2);
              $async$goto = 10;
              return A._asyncAwait(A.findLatestSdkForRelease(versionPrefix), $async$main);
            case 10:
